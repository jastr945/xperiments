...
def seed_db():
    ...
    img1 = Image(name='pigs3.jpg', url='./static/pigs3.jpg')
    img2 = Image(name='pigs4.jpg', url='./static/pigs4.jpg')

    album2 = Album(title='pofi', description="Pofi's cute pictures.")
    img3 = Image(name='pigs7.jpg', url='./static/pigs7.jpg')
    img4 = Image(name='pigs8.jpg', url='./static/pigs8.jpg')
